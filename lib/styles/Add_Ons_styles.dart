...
class AddOnsStyles {
  ...
  static BoxDecoration get headerCard => BoxDecoration(
    gradient: const LinearGradient(
      colors: <Color>[Color(0xFFFFF9F0), Color(0xFFF6ECD9)],
  ...
  static BoxDecoration get totalCard => BoxDecoration(
    gradient: const LinearGradient(
      colors: <Color>[Color(0xFFF2FAF2), Color(0xFFE6F4E7)],
    ),
  ...
  static BoxDecoration get infoCard => BoxDecoration(
    gradient: const LinearGradient(
      colors: <Color>[Color(0xFFF4FBF4), Color(0xFFE8F5E9)],
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
    ),
    borderRadius: BorderRadius.circular(20),
  ...
  static BoxDecoration get imageBox => BoxDecoration(
  ...
  static BoxDecoration get successBubble => BoxDecoration(
    gradient: const LinearGradient(
      colors: <Color>[Color(0xFF4CAF50), Color(0xFF3D9141)],
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
    ),
    borderRadius: const BorderRadius.only(
