...
class BookingModalStyles {
  ...
  static BoxDecoration modalCard = BoxDecoration(
    ...
    boxShadow: [
      ...
      BoxShadow(
        color: christmasMode
            ? christmasGold.withOpacity(0.18)
  ...
  static ButtonStyle datePickerActionButton = TextButton.styleFrom(
  ...
  static DatePickerThemeData buildDatePickerTheme() {
    return DatePickerThemeData(
      ...
      confirmButtonStyle: datePickerActionButton,
    );
  }
}
