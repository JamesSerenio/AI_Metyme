                    ...
                    Positioned.fill(
                      child: IgnorePointer(
                        child: AnimatedBuilder(
                          ...
                          builder: (context, child) {
                            return CustomPaint(
                              painter: PromoFallingSnowPainter(
...
class PromoFallingSnowPainter extends CustomPainter {
  final double progress;

  PromoFallingSnowPainter({required this.progress});
  ...
  @override
  bool shouldRepaint(covariant PromoFallingSnowPainter oldDelegate) {
