...
class _SeatPageState extends State<SeatPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    pins = [
      ...
      const SeatPin(id: '1', label: '1', x: 65, y: 30, kind: PinKind.seat),
      ...
      const SeatPin(id: '9', label: '9', x: 28, y: 39.5, kind: PinKind.seat),

      const SeatPin(id: '8A', label: '8A', x: 42, y: 39.5, kind: PinKind.seat),
      const SeatPin(id: '8B', label: '8B', x: 42.0, y: 43, kind: PinKind.seat),

      const SeatPin(id: '7A', label: '7A', x: 58, y: 39.7, kind: PinKind.seat),
      const SeatPin(id: '7B', label: '7B', x: 58.2, y: 43, kind: PinKind.seat),
      ...
      const SeatPin(id: '16', label: '16', x: 61, y: 52.2, kind: PinKind.seat),
      const SeatPin(
        id: '17',
        label: '17',
        x: 67.6,
      ...
      const SeatPin(id: '21', label: '21', x: 82, y: 68.7, kind: PinKind.seat),
